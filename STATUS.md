...
**Changed:** 8.9.2026: הליד היחיד מהריצה השבועית (3236 Central Ave) נבדק מול דף המודעה ונפסל — ה-ARV
של הכלי היה גבוה ב-16% כי הקומפס חצו רחובות; דגל 🚩רחוב הורחב לחציון קומפס מאותו רחוב. לפני כן (7.9):
`history` של RentCast = רישומים חוזרים ולא הורדות מחיר, snapshot לשבוע, ומונה בקשות שעוצר ב-50 (24/50).
